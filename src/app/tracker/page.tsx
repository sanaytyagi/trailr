            ...
            <div className="flex items-center gap-3">
              ...
              {trackedColleges.length > 0 && (
                <button
                  ...
                  className="flex items-center gap-2 rounded-xl border border-dashed border-yellow-400 bg-yellow-50 px-4 h-11 text-sm font-semibold text-yellow-700 hover:bg-yellow-100 disabled:opacity-50 transition-colors whitespace-nowrap shrink-0"

    ...
    return (
      <div className="flex h-[calc(100vh-4rem)]">
        <div className="flex h-full flex-1 min-w-0 flex-col">
          ...
          <div className="flex-1 overflow-hidden bg-muted/20 px-4 pt-6">
            <div className="mx-auto flex max-w-5xl flex-col gap-5">
              <div className="flex items-start gap-2">
                <Skeleton className="h-7 w-7 rounded-full shrink-0 mt-1" />
          ...
          <div className="border-t border-border bg-card px-4 pt-4 pb-8">

  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "bg-card fixed z-50 flex flex-col shadow-lg transition ease-in-out",
          "data-[state=open]:animate-in data-[state=closed]:animate-out",
      ...
      >
        {children}
        {showClose && (
          <DialogPrimitive.Close className="absolute top-4 right-4 rounded-full p-1 opacity-70 transition-opacity hover:opacity-100 focus:outline-none">
...
function SheetFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("mt-auto flex flex-col gap-2 border-t px-4 py-4", className)}
      {...props}
    />
  );
}

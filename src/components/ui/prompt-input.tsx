...
function PromptInputAction({
  ...
  return (
    <Tooltip {...props}>
      {/* Use render={<span />} to avoid nested <button> elements (base-ui renders Trigger as <button> by default) */}
      <TooltipTrigger render={<span className="inline-flex" />} disabled={disabled}>
        {children}
      </TooltipTrigger>
